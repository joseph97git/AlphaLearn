...
```{r}
getSymbols("AAPL", src = "yahoo", from = as.Date('2018-05-18'), to = as.Date('2019-05-18'))
```
...
chartSeries(x = AAPL, subset = '2018-05-18::2019-05-18', type = "candlesticks", theme = chartTheme("white"), up.col = "green", dn.col = "red") 
addADX(n = 10)
addSMA(n = 10)
