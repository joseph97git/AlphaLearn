...
smp_size <- floor(0.6*(data_dx_roc))
set.seed(13)
...
```{r}
plot(svm_fit, data=train, formula = AAPLClose ~ DX, fill=TRUE, svSymbol = 21, dataSymbol = 19, symbolPalette = c( "#268417", "red"), col = c("#f9dbca", "#e5f9ca"))
```
